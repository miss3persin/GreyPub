...
export const PriceSection = () => {
  return (
    ...
    {/* MSc */}
    <div className='bg-[#0A1B33] flex flex-col items-center justify-center text-white py-9 px-6 min-h-[30rem] min-w-[22rem] rounded-lg hover:shadow-[6px_7px_20px_rgba(242,208,202,0.65),-6px_7px_20px_rgba(242,208,202,0.65)] hover:scale-105 transition-all duration-300'>
