...
export const PriceSection = () => {
  return (
    ...
    <div className='bg-[#0A1B33] flex flex-col items-center justify-center text-white py-9 px-6 min-h-[30rem] max-w-[22rem] rounded-lg hover:shadow-[6px_7px_20px_rgba(242,208,202,0.65),-6px_7px_20px_rgba(242,208,202,0.65)] hover:scale-105 transition-all duration-300'>
        ...
        <p className='font-light text-[0.865rem] text-center mb-4 text-[#D0D2D4]'>Balanced plan for typical BSc/MSc research projects</p>
    ...
    <div className='bg-[#0A1B33] text-white py-9 px-6 min-h-[30rem] max-w-[22rem] rounded-lg hover:shadow-[6px_7px_20px_rgba(242,208,202,0.65),-6px_7px_20px_rgba(242,208,202,0.65)] hover:scale-105 transition-all duration-300'>
        ...
        <p className='font-light text-[0.865rem] text-center mb-4 text-[#D0D2D4]'>For simpler projects needing minimal code or write-ups</p>
        ...
        <div className='flex items-center gap-4 mb-3'>
            <Image src={good_icon}/>
            <p className='font-light text-[1rem]'>Code Implementation</p>
        </div>

        <div className='flex items-center gap-4 mb-3'>
            <Image src={good_icon}/>
            <p className='font-light text-[1rem]'>Chapters Writeup</p>
        </div>

        <div className='flex items-center gap-4 mb-3'>
            <Image src={good_icon}/>
            <p className='font-light text-[1rem]'>Low plagerism</p>
        </div>

        <div className='flex items-center gap-4 mb-3'>
            <Image src={good_icon}/>
            <p className='font-light text-[1rem]'>Low AI checker score</p>
        </div>

        <div className='flex items-center gap-4 mb-3'>
            <Image src={good_icon}/>
            <p className='font-light text-[1rem]'>Presentation slides</p>
        </div>
    ...
    <div className='bg-[#0A1B33] flex flex-col items-center justify-center text-white py-9 px-6 min-h-[30rem] max-w-[22rem] rounded-lg hover:shadow-[6px_7px_20px_rgba(242,208,202,0.65),-6px_7px_20px_rgba(242,208,202,0.65)] hover:scale-105 transition-all duration-300'>
        ...
        <p className='font-light text-[0.865rem] mb-4 text-center text-[#D0D2D4]'>Comprehensive support for PhD projects or advanced research</p>
        <button className='border-2 cursor-default border-[#FF4B26] w-full font-medium text-[0.865rem] py-3 rounded mb-10 transition duration-200 ease-in-out transform hover:bg-[#FF4B26] hover:scale-105'>Coming Soon</button>
